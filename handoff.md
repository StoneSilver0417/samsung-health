...
- **배포 상태**: GitHub 저장소 공개 전환 완료, v1.6.0/v1.6.1/v1.6.2 Release 생성 완료.
  **v1.6.3은 아직 Release 미생성, 폰에도 미설치** — 다음 세션 최우선
...
- AI 러닝 요약: v1.6.3까지 버그 3건 수정했으나, 실기기에서 최종 정상 동작 확인은 아직 안 됨
  (같은 실기기 테스트에서 매번 다른 새 문제가 나왔던 이력이 있어 재확인 필수)

## 다음 TODO

1. [ ] GitHub에서 v1.6.3 태그 + APK 첨부한 Release 생성
